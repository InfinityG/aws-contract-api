...
/**
 * ### .createRestApiMethodResponse(apiResponseMethod, patch)
 *
 * @api public
 * @param {{}} apiMethodResponse
 * @param {AwsRestApiMethod} awsApiMethod
 *
 */

ApiGatewayApi.prototype.createRestApiMethodResponse = function(apiMethodResponse, awsApiMethod) {

  if (!awsApiMethod._links || !awsApiMethod._links['methodresponse:put']) {
    throw new Error('invalid AwsRestApiMethod in createRestApiMethodResponse()');
  }

  var body = JSON.stringify(apiMethodResponse.excludeKeys(['_log', '_aws']));

  var request = this.createRequest({
    method: 'PUT',
    path: awsApiMethod._links['methodresponse:put'].href.replace(/\{status_code\}/, apiMethodResponse.statusCode),
    body: body,
  });
...
ApiGatewayApi.prototype.createRestApiMethodIntegration = function(integration, awsApiMethod, resource) {
  ...
  var request = this.createRequest({
    ...
    body: JSON.stringify(integration.excludeKeys(['_log', '_aws', 'lambda', '_permission']))
  });
...
/**
 * ### .deleteRestApiMethodIntegration()
 *
 * @api public
 * @param {AwsRestApiMethodIntegration} awsApiMethodIntegration
 * @returns {Promise}
 *
 */

ApiGatewayApi.prototype.deleteRestApiMethodIntegration = function(awsApiMethodIntegration) {

  if (!awsApiMethodIntegration._links || !awsApiMethodIntegration._links['integration:delete']) {
    throw new Error('invalid AwsRestApiMethodIntegration in deleteRestApiMethodIntegration()');
  }

  var request = this.createRequest({
    method: 'DELETE',
    path: awsApiMethodIntegration._links['integration:delete'].href,
  });
...
/**
 * ### .createRestApiMethodIntegrationResponse(awsIntegrationResponse)
 *
 * @api public
 * @param {AwsRestApiMethodIntegrationResponse} awsIntegrationResponse
 * @param {AwsRestApiMethodIntegration} awsApiMethodIntegration
 * @returns {Promise}
 *
 */

ApiGatewayApi.prototype.createRestApiMethodIntegrationResponse = function(apiIntegrationResponse, awsApiMethodIntegration) {

  if (!awsApiMethodIntegration._links || !awsApiMethodIntegration._links['integrationresponse:put']) {
    throw new Error('invalid AwsRestApiMethodIntegrationResponse in deleteRestApiMethodIntegrationResponse()');
  }

  var request = this.createRequest({
    method: 'PUT',
    path: awsApiMethodIntegration._links['integrationresponse:put'].href.replace(/\{status_code\}/, apiIntegrationResponse.statusCode),
    body: JSON.stringify(apiIntegrationResponse.excludeKeys(['_aws', '_log']))
  });
...
/**
 * ### .deleteRestApiMethodIntegrationResponse(awsIntegrationResponse)
 *
 * @api public
 * @param {AwsRestApiMethodIntegrationResponse} awsIntegrationResponse
 * @returns {Promise}
...
ApiGatewayApi.prototype.deleteRestApiMethodIntegrationResponse = function(awsIntegrationResponse) {

  if (!awsIntegrationResponse._links || !awsIntegrationResponse._links['integrationresponse:delete']) {
    throw new Error('invalid AwsRestApiMethodIntegrationResponse in deleteRestApiMethodIntegrationResponse()');
  }

  var request = this.createRequest({
    method: 'DELETE',
    path: awsIntegrationResponse._links['integrationresponse:delete'].href,
  });
...
/**
 * ### .patchRestApiMethodIntegrationResponse(awsIntegrationResponse)
 *
 * @api public
 * @param {AwsRestApiMethodIntegrationResponse} awsIntegrationResponse
 * @param {JsonPatch} patch
...
ApiGatewayApi.prototype.patchRestApiMethodIntegrationResponse = function(awsIntegrationResponse, patch) {

  if (!awsIntegrationResponse._links || !awsIntegrationResponse._links['integrationresponse:update']) {
    throw new Error('invalid AwsRestApiMethodIntegrationResponse in deleteRestApiMethodIntegrationResponse()');
  }

  this.removePatchNulls(['/responseTemplates', '/responseParameters'], patch);

  var request = this.createRequest({
    method: 'PATCH',
    path: awsIntegrationResponse._links['integrationresponse:update'].href,
    body: JSON.stringify({ patchOperations: patch }),
  });
