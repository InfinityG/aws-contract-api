...
module.exports.updateApiResourceMethod = function(aws, apiTree, awsResource, apiMethod) {
  ...
  .then(function(result) {
    ...
    var changeables = awsApiMethodIntegration.excludeKeys['xxx'];


    // console.log('CC', changeables);


    // console.log('CREATED', awsApiMethodIntegration);
