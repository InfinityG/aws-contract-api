...
module.exports.updateApiResourceMethod = function(aws, apiTree, awsResource, apiMethod) {
  ...
  .then(function(awsApiMethodIntegration) {
    ...
    if (integration.lambda) {
      return module.exports.createOrUpdateLambda(aws, apiTree, apiMethod, awsApiMethod, awsApiMethodIntegration)
    }
 ...
 * @param {AwsApiList} aws
 * @param {ApiMethod} apiMethod
 * @param {AwsApiMethod} awsApiIntegration
 * @param {AwsApiMethodIntegration} awsApiMethodIntegration
 * @returns {Promise}
 *
 */

module.exports.createOrUpdateLambda = function(aws, apiTree, apiMethod, awsApiMethod, awsApiMethodIntegration) {

  var integration = apiMethod.definition.integration;
  var lambda = Lambda.load(integration.lambda, apiTree.version, aws.lambda.stage);

  createOrUpdateLambda('name: \'%s\'', lambda.name);
