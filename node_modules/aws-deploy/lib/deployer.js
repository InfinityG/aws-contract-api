...
module.exports.updateApiResourceMethod = function(apigw, apiTree, awsResource, apiMethod) {
  ...
  .then(function(awsApiMethod) {
    ...
    if (!method) return updateTarget = awsApiMethod;
    ...
    if (different.length > 0) return updateTarget = awsApiMethod;
  ...
  .then(function(updateTarget) {
    ...
    if (updateTarget) {
      ...
      return apigw.patchRestApiMethod(method, updateTarget, awsResource);
    }
