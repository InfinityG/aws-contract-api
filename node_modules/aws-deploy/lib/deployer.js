...
function Deployer(config, apiTree) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    .then(function() {
      ...
      if (found) {
        debug('updating name: \'%s\', id: \'%s\'', found.name, found.id);
        return found;
      }
  ...
  return new Promise(function(resolve, reject) {
    ...
    .then(function(resources) {
      ...
      return Promise.map(reversed, function(awsResource) {
        return module.exports.updateApiResource(aws, apiTree, awsResource);
      });
...
module.exports.createApiResources = function(aws, apiTree, awsRestApi) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    var recurse = function() {
      ...
      aws.apigw.createRestApiResource({pathPart: resource.pathPart}, parent._aws_entity)
...
module.exports.updateApiResource = function(aws, apiTree, awsResource) {
  ...
  .then(function() {
    ...
    return Promise.map(allMethods, function(apiMethod) {
      ...
      return module.exports.updateApiResourceMethod(aws, apiTree, awsResource, apiMethod);
...
module.exports.updateApiResourceMethod = function(aws, apiTree, awsResource, apiMethod) {
  ...
  .then(function(doUpdate) {
    ...
    if (doUpdate) {
      ...
      updateApiResourceMethod(
        'method: \'%s\', path: \'%s\' CHANGED', apiMethod.method, awsResource.path
      );
    ...
    updateApiResourceMethod(
      'method: \'%s\', path: \'%s\' unchanged', apiMethod.method, awsResource.path
    );
  ...
  .then(function() {
    ...
    // TODO: connect gateway to lambda
...
module.exports.createApiResourceMethod = function(aws, apiTree, awsResource, apiMethod) {
  ...
  .then(function(awsMethod) {
    ...
    createApiResourceMethod('method: \'%s\', path: \'%s\' CREATED', apiMethod.method, awsResource.path);
...
/**
 * ### .createOrUpdateLambda(aws, apiMethod, awsApiMethod, awsApiMethodIntegration)
 *
 * Create method on the Api Gateway with method from the apiTree
 *
 * @api private
...
module.exports.createOrUpdateLambda = function(aws, apiTree, apiMethod) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    .then(function(result) {
      ...
      var changeables = awsLambdaFunction.Configuration.subset([
        'Description', 'Handler', 'MemorySize', 'Role', 'Timeout'
      ]);

      var different = diff(changeables, lambda.toUpdateFunctionConfiguration());
      if (different.length > 0) {
        unchanged = false;
        createOrUpdateLambda('lambda: \'%s\' CHANGED config \'%j\'', lambda.file, different);
    ...
    .then(function(result) {
      if (unchanged) {
        ...
        // integration._aws_resource = awsLambdaFunction; // sensitive data
