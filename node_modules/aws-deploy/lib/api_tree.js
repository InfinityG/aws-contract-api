  ...
  Object.keys(this.routes).forEach(function(path) {
    ...
    httpMethods.forEach(function(httpMethod) {
      ...
      ['method', 'integration'].forEach(function(name) {
        ...
        if (record && record.responses && thing.responses) {
          Object.keys(thing.responses).forEach(function(key) {
            if (record.responses[key]) {
              thing.responses[key]._log = record.responses[key]._log;
            }
          });
        }
