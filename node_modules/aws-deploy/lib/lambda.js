...
module.exports.load = function(jsFile, deployStage) {

  return cache[jsFile] || (cache[jsFile] = new Lambda(jsFile, deployStage));
...
function Lambda(jsFile, deployStage) {

  this.stage = deployStage || 'development';

  debug('create lambda: \'%s\', for stage: \'%s\'', jsFile, this.stage);
